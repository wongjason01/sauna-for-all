...
# Generated by build.py from SITE_URL. Copied verbatim -- no asset inlining
# applies to them, and they must sit at the site root to be found.
...
def main():
    ...
    for name in ROOT_FILES:
        ...
        if not os.path.isfile(src_path):
            raise RuntimeError(
                f"{name} missing -- run build.py first; it generates this "
                "from SITE_URL.")
